      ...
      for(let i=0;i<7;i++)
      {
        ...
        while(currentDate<endTime)
        {
         ...
         if(timeSlots.length>0)
          setDocSlots(prev => ([...prev,timeSlots])) // it will store all the slots of the next days
      }
  }
    ...
    <div>
       ...
       <div className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex-1 border border-[#ADADAD] rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          {/* doctor about */}
          <div>
            <p className='flex items-center gap-1 text-sm font-medium text-[#262626] mt-3'>About <img src={assets.info_icon} alt="" />
            </p>
       ...
       <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <button className='bg-primary text-white text-sm font-light px-14 py-3 mt-6 rounded-full'>Book Appointment</button>
       </div>
    </div>
  )
}
