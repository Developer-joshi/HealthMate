          ...
          {appointments.slice(0, 4).map((item, index) => (
            ...
            >
              ...
              <div className="flex flex-col justify-end gap-2">
                {!item.cancelled && <button onClick={()=>{appointmentRazorpay(item._id)}} className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-primary hover:text-white transition-all duration-300ms">
                  Pay Online
                </button>}
